...
Description
----
The "Contact registrations" component has been developed for the municipality of Utrecht and has the function of sending SMS, E-Mail, Whatsapp messages or regular mail to citizens, based on pre-set templates. It is also possible to view messages with the correct credentials.
